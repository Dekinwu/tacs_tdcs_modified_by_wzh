...
//const unsigned int f64Array_Sin[]={1365,1498,1631,1761,1887,2008,2123,2230,2330,2420,2499,2568,2626,2671,2703,2723,2730,2723,2703,2671,2626,2568,2499,2420,2330,2230,2123,2008,1887,1761,1631,1498,1365,1232,1099,969,843,722,607,500,400,310,231,162,104,59,27,7,0,7,27,59,104,162,231,310,400,500,607,722,843,969,1099,1232,};
...
__interrupt void Port_1(void)
{
   ...
   { 
      ...
      case 0x5d:
        ...
        {
          wavefrequency += FM_STEP;
          if(wavefrequency > MAX_FM)  wavefrequency = MAX_FM;
        }
      ...
      case 0x80: 
        ...
        {
          wavefrequency -= FM_STEP;
          if(wavefrequency < MIN_FM)  wavefrequency = MIN_FM;
        }
        if(fsm_state==AM_SET_STA)
        {
           waveamplitude -= AM_STEP;
